...
require (
	...
	github.com/jsmithdenverdev/pager/pkg/apigateway v1.0.2
	github.com/jsmithdenverdev/pager/pkg/authz v1.4.1
	github.com/jsmithdenverdev/pager/pkg/middleware v1.2.0
